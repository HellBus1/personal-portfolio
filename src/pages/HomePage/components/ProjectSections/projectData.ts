...
export const projectsData: Project[] = [
  {
    ...
    path: 'https://play.google.com/store/apps/details?id=com.digiventure.ventnote',
  ...
  },
  {
    ...
    name: 'VentFit',
    shortDescription:
      'VentFit empowers your health journey with a BMI Calculator and more, built with Flutter.',
    banner:
    ...
    path: 'https://play.google.com/store/apps/details?id=com.digiventure.ventfit',
    createdAt: { seconds: 1680714000, nanoseconds: 384000000 },
  ...
  },
  {
    ...
    path: 'https://investcount.pages.dev/',
    createdAt: { seconds: 1680714000, nanoseconds: 384000000 },
  ...
  },
  {
    ...
    shortDescription:
      'A repository dedicated to exploring the industry standards of software engineering with Spring Boot.',
    banner:
    ...
    path: 'https://github.com/HellBus1/spring-playground',
    createdAt: { seconds: 1680714000, nanoseconds: 384000000 },
  ...
  },
  {
    ...
    shortDescription:
      'React Tailwind Starter is a React.js template with Vite, packed with all the essential libraries.',
    banner:
    ...
    path: 'https://github.com/HellBus1/ts-react-tailwind-starter',
    createdAt: { seconds: 1680714000, nanoseconds: 384000000 },
    stacks: ['typescript', 'tailwindcss', 'daisyui', 'react']
  }
]
