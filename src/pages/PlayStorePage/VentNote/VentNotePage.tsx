          ...
          <div className='flex items-center gap-3 mb-6'>
            ...
            <div>
              ...
              <p className='text-neutral-content/70 mt-2'>
                VentNote App • Effective March 26, 2023
              </p>
            </div>
          </div>
        </div>
        ...
        <div className='space-y-10'>
          ...
          <section className='bg-base-100 rounded-2xl shadow-sm border border-base-content p-8'>
            <p className='text-neutral-content/80 leading-relaxed mb-6'>
              DigiVenture built the VentNote app as an Ad Supported app. This SERVICE is provided by
            ...
            <p className='text-neutral-content/80 leading-relaxed'>
              ...
              Conditions, which are accessible at VentNote unless otherwise defined in this Privacy
              Policy.
            </p>
          </section>
